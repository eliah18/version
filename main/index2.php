...
include "conn.php";
session_start();
if(isset($_SESSION['access']) && isset($_SESSION['username']) &&  $_SESSION['access']=='2') { 
            ...
            <div class="card-body">
                <form method="POST" action="" >
                    <div class="mb-3">
                        ...
                        <input type="text" id="company" name="company" value=""  readonly="true" class="form-control span12">
                        <input type="hidden" id="company" name="company_code" value=""  readonly="true" class="form-control span12">
                        <select id="company" name="" class="form-control form-select form-select-lg" onchange="getBranches(this.value)">
