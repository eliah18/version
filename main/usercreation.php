...
if(isset($_SESSION['access']) && isset($_SESSION['username']) &&  $_SESSION['access']=='1') { 
  ...
  $email = $_POST["email"];
    ...
    $query="INSERT INTO `users`(`email`, `phone`, `level`, `company`, `Branch`)
 VALUES ('$email','$phone','$access_level','$company_code','$Branch')";
if($connection-> query($query))
{
    echo ("<script> alert('User added Successfully');window.location='usercreation.php';</script>");
}
		  ...
		  <div class="card shadow-sm">
            <div class="card-body">
              <form method="POST" action="" >
                ...
                <input type="text" name="email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$"  placeholder="enter email"  required="" class="form-control span12">
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label" aria-label="Default select example">Fon Number</label>
                        <input type="text" name="phone"  placeholder="07******"  required="" class="form-control span12">
                    ...
                    <div class="mb-3">
                        <label for="level" class="form-label" aria-label="Default select example">Level</label>
                  ...
                  <!--  <div class="mb-3">
					...
					<button type="submit" name="btnSubmit" class="btn btn-success col-md-3">Submit <i class="fa fa-ok  bold"></i></button>
                    </div>
                </form>
            </div>
        </div>
