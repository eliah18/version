...
ob_start();
session_start();
if(isset($_SESSION['access']) && isset($_SESSION['username']) && isset($_SESSION['useraccess']) && isset($_SESSION['Objects']) && isset($_SESSION['Company_code'])  &&  $_SESSION['access']=='3') { 

$company_code = $_SESSION['Company_code'];

$devices = $_SESSION['Objects'];
...
<div class="content">
 ...
 <div class="mb-3">
                        ...
                        <select id="company" name="company_code" class="form-control form-select form-select-lg" width="50%" aria-readonly="true" disabled>
                        <option value=""  >Select Company </option>
                            <option value="02" <?php if(isset($_SESSION['Company_code']) && $_SESSION['Company_code'] =='02' ){echo 'selected = "selected"';} ?>>ALLIED TIMBERS</option>
                                <option value="01" <?php if(isset($_SESSION['Company_code']) && $_SESSION['Company_code'] =='01' ){echo 'selected = "selected"';} ?> >ZETDC</option>
                                <option value="00" <?php if(isset($_SESSION['Company_code']) && $_SESSION['Company_code'] =='00' ){echo 'selected = "selected"';} ?> >BANTU TRACK</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="devices" class="form-label" aria-label="Default select example">Objects</label>
