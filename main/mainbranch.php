...
ob_start();
session_start(); 
if(isset($_SESSION["company_code"]) && isset($_SESSION["Branch"]) && isset($_SESSION["fromdate"]) && isset($_SESSION["todate"])){
...
if($_SESSION['Company'] == '02'){
    ...
    if ($Company != "" && $Branch != 'all')
   {
    ...
    $sql="call Fleet_Size_branch('$Company','$fromdate','$todate','$Branch')";
    ...
    $sqli="call perfomance_matrix_branch('$Company','$fromdate','$todate','$Branch')";
    ...
    $sqlBr="call OverSpeeding_Branch('$Company','$fromdate','$todate','$Branch')";
    if ($speedingBranch= mysqli_query($con,$sqlBr)){
      do{
        if($speedingBranch != ""){
     
          while ($rezbr= mysqli_fetch_assoc($speedingBranch) ){
    ...
    $sqlizbr="call after_hours_Branch('$Company','$fromdate','$todate','$Branch')";
    ...
    if ($Company != "")
   {
    ...
    $sql="call Fleet_Size_ZETDC_Branch('$Company','$fromdate','$todate')";
    ...
    $sqlBr01="call OverSpeeding_Branch('$Company','$fromdate','$todate','$Branch')";
    ...
    $sqlizybr01="call afterhours_ZETDC_Branch('$Company','$fromdate','$todate')";
    ...
    while(mysqli_next_result($con));
       ...
       $sqlixfiz01="call perfomance_matrix_ZETDC('$Company','$fromdate','$todate')";
